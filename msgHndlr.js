...
// apikey you can get it at https://mhankbarbar.herokuapp.com/api
        ...
        const ownerNumber = ["6285877075481@c.us","55xxxxx"] // replace with your whatsapp number
        ...
        case '!fb':
            ...
            break
        case '!creator':
            client.sendContact(from, '6285877075481@c.us')
            break
        case '!ig':
        ...
        case '!bc':
            ...
            for (let ids of chatz) {
                ...
                if (!cvk.isReadOnly) await client.sendText(ids, `[ *Kaguya BOT Broadcast* ]\n\n${msg}`)
            }
        ...
        case '!leave':
            if (!isGroupMsg) return client.reply(from, 'Perintah ini hanya bisa di gunakan dalam group', id)
            if (!isGroupAdmins) return client.reply(from, 'Perintah ini hanya bisa di gunakan oleh admin group', id)
            await client.sendText(from,'Sayonaraa✨').then(() => client.leaveGroup(groupId))
            break
        case '!promote':
            if (!isGroupMsg) return client.reply(from, 'Fitur ini hanya bisa di gunakan dalam group', id)
        ...
        case '!join':
            ...
            if (key !== 'Q70k0Y9YWRSfLfSuhkpf') return client.reply(from, '*key* salah! silahkan chat owner bot unruk mendapatkan key yang valid', id)
        ...
        case '!readme':
            ...
            break
        case '!info':
            client.sendLinkWithAutoPreview(from, '*KaguyaBOT*', info)
            break
        case '!snk':
