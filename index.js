...
const start = async (client = new Client()) => {
        ...
        client.onAddedToGroup(((chat) => {
            ...
            if (totalMem < 20) { 
            	client.sendText(chat.id, `Kurang Member bang membernya cuman ${totalMem}, Kalo mau invite bot, minimal jumlah mem ada 20`).then(() => client.leaveGroup(chat.id)).then(() => client.deleteChat(chat.id))
            } else {
